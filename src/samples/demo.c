...
getoneparam(const char *paramName)
{
           ...
           || TMR_PARAM_TAGOP_ANTENNA == param)
  {
    ...
    printf("%u\n", value);
           ...
           || TMR_PARAM_STATUS_ENABLE_ANTENNAREPORT == param
           || TMR_PARAM_STATUS_ENABLE_FREQUENCYREPORT == param
           || TMR_PARAM_STATUS_ENABLE_TEMPERATUREREPORT == param)
  {
    bool value;
    ret = TMR_paramGet(rp, param, &value);
    if (TMR_SUCCESS != ret)
  ...
  else if (TMR_PARAM_READER_STATISTICS == param)
  {
